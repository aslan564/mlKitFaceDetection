...
package com.mlkit.demo.preference;
...
import com.mlkit.demo.CameraSource.SizePair;
...
public class PreferenceUtils {
  ...
  public static FaceDetectorOptions getFaceDetectorOptions(Context context) {
    // gozun konturlarinin adini qaytarir
    int landmarkMode =
    ...
    // sifet conturlarini goturur
    int contourMode =
        getModeTypePreferenceValue(
            context,
            R.string.pref_key_live_preview_face_detection_contour_mode,
            FaceDetectorOptions.CONTOUR_MODE_ALL);
    // sifet conturlarininin tam detallarini qaytarir
    ...
    // sifet conturlarininin tam suretli veya slow olmasini temin edir
    int performanceMode =
        getModeTypePreferenceValue(
            context,
